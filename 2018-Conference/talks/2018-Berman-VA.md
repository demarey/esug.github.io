...
**Abstract:**
VA Smalltalk is continuing to push aggressively into the future with new virtual machine platforms and numerous features.  I'm going to talk about the success story of our VA Smalltalk 64-bit launch last September, cover all the new capability in the current release, and discuss what's coming up next for the VA Smalltalk product.
