...
**Abstract:** In this talk, I will present the features, advantages and disadvantages of the object model based on prototypes used in the Self programming language. I will describe how to use prototypes in Pharo and show some details of the implementation.   
