...
For this, we dive in Spec’s architecture and explain how we do test the different concerns with different kind of tests - layouting, presenter behaviour, backend integration.
